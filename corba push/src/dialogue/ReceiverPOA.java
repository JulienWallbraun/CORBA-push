...
/**
 * dialogue/ReceiverPOA.java . Generated by the IDL-to-Java compiler (portable), version "3.2" from receiver.idl samedi 3 janvier 2015 12 h 04 CET
 */

public abstract class ReceiverPOA extends org.omg.PortableServer.Servant implements dialogue.ReceiverOperations, org.omg.CORBA.portable.InvokeHandler {
    ...
    private static String[] __ids = { "IDL:dialogue/Receiver:1.0" };
    ...
    public Receiver _this() {
        return ReceiverHelper.narrow(super._this_object());
    }

    public Receiver _this(org.omg.CORBA.ORB orb) {
        return ReceiverHelper.narrow(super._this_object(orb));
    }
