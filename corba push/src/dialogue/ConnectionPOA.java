...
/**
 * dialogue/ConnectionPOA.java . Generated by the IDL-to-Java compiler (portable), version "3.2" from connection.idl samedi 3 janvier 2015 11 h 54 CET
 */

public abstract class ConnectionPOA extends org.omg.PortableServer.Servant implements dialogue.ConnectionOperations, org.omg.CORBA.portable.InvokeHandler {
    ...
    private static String[] __ids = { "IDL:dialogue/Connection:1.0" };
    ...
    public Connection _this() {
        return ConnectionHelper.narrow(super._this_object());
    }

    public Connection _this(org.omg.CORBA.ORB orb) {
        return ConnectionHelper.narrow(super._this_object(orb));
    }
